...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-O1 -Wl,--as-needed',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--prefix=/usr' '--build=x86_64-pc-linux-gnu' "
                "'--host=x86_64-pc-linux-gnu' '--mandir=/usr/share/man' "
                "'--infodir=/usr/share/info' '--datadir=/usr/share' "
                "'--sysconfdir=/etc' '--localstatedir=/var/lib' "
                "'--docdir=/usr/share/doc/python-3.9.9-r1' "
                "'--htmldir=/usr/share/doc/python-3.9.9-r1/html' "
                "'--libdir=/usr/lib64' 'ac_cv_header_stropts_h=no' "
                "'--enable-shared' '--enable-ipv6' '--infodir=/usr/share/info' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/var/tmp/portage/dev-lang/python-3.9.9-r1/work/Python-3.9.9/coverage.info',
 'COVERAGE_REPORT': '/var/tmp/portage/dev-lang/python-3.9.9-r1/work/Python-3.9.9/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -I/usr/include/ncursesw',
 'CXX': 'x86_64-pc-linux-gnu-g++ -pthread',
 'DESTDIRS': '/usr /usr/lib64 /usr/lib/python3.9/lib-dynload',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.9.9-r1/work/Python-3.9.9',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.9.9-r1/work/Python-3.9.9 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.9.9-r1/work/Python-3.9.9 '
 ...
 'abs_builddir': '/var/tmp/portage/dev-lang/python-3.9.9-r1/work/Python-3.9.9',
 'abs_srcdir': '/var/tmp/portage/dev-lang/python-3.9.9-r1/work/Python-3.9.9',
