...
cnf/make.conf.example.alpha.diff
cnf/make.conf.example.amd64-fbsd.diff
cnf/make.conf.example.amd64.diff
cnf/make.conf.example.arm.diff
cnf/make.conf.example.arm64.diff
cnf/make.conf.example.hppa.diff
cnf/make.conf.example.ia64.diff
cnf/make.conf.example.m68k.diff
cnf/make.conf.example.mips.diff
cnf/make.conf.example.ppc.diff
cnf/make.conf.example.ppc64.diff
cnf/make.conf.example.riscv.diff
cnf/make.conf.example.s390.diff
cnf/make.conf.example.sh.diff
cnf/make.conf.example.sparc-fbsd.diff
cnf/make.conf.example.sparc.diff
cnf/make.conf.example.x86-fbsd.diff
cnf/make.conf.example.x86.diff
cnf/make.globals
cnf/repos.conf
...
doc/package/ebuild/eapi/4-slot-abi.docbook
...
lib/portage/xpak.py
lib/portage.egg-info/PKG-INFO
lib/portage.egg-info/SOURCES.txt
lib/portage.egg-info/dependency_links.txt
lib/portage.egg-info/not-zip-safe
lib/portage.egg-info/top_level.txt
...
lib/portage/package/ebuild/_config/unpack_dependencies.py
...
lib/portage/tests/__init__.py
lib/portage/tests/runTests.py
lib/portage/tests/bin/__init__.py
lib/portage/tests/bin/__test__.py
lib/portage/tests/bin/setup_env.py
lib/portage/tests/bin/test_dobin.py
lib/portage/tests/bin/test_dodir.py
lib/portage/tests/bin/test_doins.py
lib/portage/tests/bin/test_eapi7_ver_funcs.py
lib/portage/tests/bin/test_filter_bash_env.py
lib/portage/tests/dbapi/__init__.py
lib/portage/tests/dbapi/__test__.py
lib/portage/tests/dbapi/test_auxdb.py
lib/portage/tests/dbapi/test_fakedbapi.py
lib/portage/tests/dbapi/test_portdb_cache.py
lib/portage/tests/dep/__init__.py
lib/portage/tests/dep/__test__.py
lib/portage/tests/dep/testAtom.py
lib/portage/tests/dep/testCheckRequiredUse.py
lib/portage/tests/dep/testExtendedAtomDict.py
lib/portage/tests/dep/testExtractAffectingUSE.py
lib/portage/tests/dep/testStandalone.py
lib/portage/tests/dep/test_best_match_to_list.py
...
lib/portage/tests/dep/test_dep_getusedeps.py
lib/portage/tests/dep/test_dnf_convert.py
lib/portage/tests/dep/test_get_operator.py
lib/portage/tests/dep/test_get_required_use_flags.py
lib/portage/tests/dep/test_isjustname.py
lib/portage/tests/dep/test_isvalidatom.py
lib/portage/tests/dep/test_match_from_list.py
lib/portage/tests/dep/test_overlap_dnf.py
lib/portage/tests/dep/test_paren_reduce.py
...
lib/portage/tests/ebuild/test_array_fromfile_eof.py
lib/portage/tests/ebuild/test_config.py
lib/portage/tests/ebuild/test_doebuild_fd_pipes.py
lib/portage/tests/ebuild/test_doebuild_spawn.py
lib/portage/tests/ebuild/test_fetch.py
lib/portage/tests/ebuild/test_ipc_daemon.py
lib/portage/tests/ebuild/test_shell_quote.py
lib/portage/tests/ebuild/test_spawn.py
lib/portage/tests/ebuild/test_use_expand_incremental.py
lib/portage/tests/emerge/__init__.py
lib/portage/tests/emerge/__test__.py
lib/portage/tests/emerge/test_config_protect.py
lib/portage/tests/emerge/test_emerge_blocker_file_collision.py
lib/portage/tests/emerge/test_emerge_slot_abi.py
lib/portage/tests/emerge/test_global_updates.py
lib/portage/tests/emerge/test_simple.py
...
lib/portage/tests/glsa/test_security_set.py
lib/portage/tests/lafilefixer/__init__.py
lib/portage/tests/lafilefixer/__test__.py
lib/portage/tests/lafilefixer/test_lafilefixer.py
lib/portage/tests/lazyimport/__init__.py
lib/portage/tests/lazyimport/__test__.py
lib/portage/tests/lazyimport/test_lazy_import_portage_baseline.py
lib/portage/tests/lazyimport/test_preload_portage_submodules.py
lib/portage/tests/lint/__init__.py
lib/portage/tests/lint/__test__.py
lib/portage/tests/lint/metadata.py
lib/portage/tests/lint/test_bash_syntax.py
lib/portage/tests/lint/test_compile_modules.py
lib/portage/tests/lint/test_import_modules.py
lib/portage/tests/locks/__init__.py
lib/portage/tests/locks/__test__.py
lib/portage/tests/locks/test_asynchronous_lock.py
lib/portage/tests/locks/test_lock_nonblock.py
lib/portage/tests/news/__init__.py
lib/portage/tests/news/__test__.py
lib/portage/tests/news/test_NewsItem.py
lib/portage/tests/process/__init__.py
lib/portage/tests/process/__test__.py
lib/portage/tests/process/test_AsyncFunction.py
lib/portage/tests/process/test_PipeLogger.py
lib/portage/tests/process/test_PopenProcess.py
lib/portage/tests/process/test_PopenProcessBlockingIO.py
lib/portage/tests/process/test_poll.py
lib/portage/tests/process/test_unshare_net.py
...
lib/portage/tests/resolver/test_aggressive_backtrack_downgrade.py
lib/portage/tests/resolver/test_autounmask.py
lib/portage/tests/resolver/test_autounmask_binpkg_use.py
lib/portage/tests/resolver/test_autounmask_keep_keywords.py
lib/portage/tests/resolver/test_autounmask_multilib_use.py
lib/portage/tests/resolver/test_autounmask_parent.py
lib/portage/tests/resolver/test_autounmask_use_backtrack.py
lib/portage/tests/resolver/test_autounmask_use_breakage.py
lib/portage/tests/resolver/test_autounmask_use_slot_conflict.py
lib/portage/tests/resolver/test_backtracking.py
lib/portage/tests/resolver/test_bdeps.py
lib/portage/tests/resolver/test_binary_pkg_ebuild_visibility.py
lib/portage/tests/resolver/test_blocker.py
lib/portage/tests/resolver/test_changed_deps.py
lib/portage/tests/resolver/test_circular_choices.py
lib/portage/tests/resolver/test_circular_choices_rust.py
lib/portage/tests/resolver/test_circular_dependencies.py
lib/portage/tests/resolver/test_complete_graph.py
lib/portage/tests/resolver/test_complete_if_new_subslot_without_revbump.py
lib/portage/tests/resolver/test_depclean.py
lib/portage/tests/resolver/test_depclean_order.py
lib/portage/tests/resolver/test_depclean_slot_unavailable.py
lib/portage/tests/resolver/test_depth.py
lib/portage/tests/resolver/test_disjunctive_depend_order.py
lib/portage/tests/resolver/test_eapi.py
lib/portage/tests/resolver/test_features_test_use.py
lib/portage/tests/resolver/test_imagemagick_graphicsmagick.py
lib/portage/tests/resolver/test_keywords.py
lib/portage/tests/resolver/test_merge_order.py
lib/portage/tests/resolver/test_missing_iuse_and_evaluated_atoms.py
lib/portage/tests/resolver/test_multirepo.py
lib/portage/tests/resolver/test_multislot.py
lib/portage/tests/resolver/test_old_dep_chain_display.py
lib/portage/tests/resolver/test_onlydeps.py
lib/portage/tests/resolver/test_onlydeps_circular.py
lib/portage/tests/resolver/test_onlydeps_minimal.py
lib/portage/tests/resolver/test_or_choices.py
lib/portage/tests/resolver/test_or_downgrade_installed.py
lib/portage/tests/resolver/test_or_upgrade_installed.py
lib/portage/tests/resolver/test_output.py
lib/portage/tests/resolver/test_package_tracker.py
lib/portage/tests/resolver/test_profile_default_eapi.py
lib/portage/tests/resolver/test_profile_package_set.py
lib/portage/tests/resolver/test_rebuild.py
lib/portage/tests/resolver/test_regular_slot_change_without_revbump.py
lib/portage/tests/resolver/test_required_use.py
lib/portage/tests/resolver/test_runtime_cycle_merge_order.py
lib/portage/tests/resolver/test_simple.py
lib/portage/tests/resolver/test_slot_abi.py
lib/portage/tests/resolver/test_slot_abi_downgrade.py
lib/portage/tests/resolver/test_slot_change_without_revbump.py
lib/portage/tests/resolver/test_slot_collisions.py
lib/portage/tests/resolver/test_slot_conflict_force_rebuild.py
lib/portage/tests/resolver/test_slot_conflict_mask_update.py
lib/portage/tests/resolver/test_slot_conflict_rebuild.py
lib/portage/tests/resolver/test_slot_conflict_unsatisfied_deep_deps.py
lib/portage/tests/resolver/test_slot_conflict_update.py
lib/portage/tests/resolver/test_slot_conflict_update_virt.py
lib/portage/tests/resolver/test_slot_operator_autounmask.py
lib/portage/tests/resolver/test_slot_operator_bdeps.py
lib/portage/tests/resolver/test_slot_operator_complete_graph.py
lib/portage/tests/resolver/test_slot_operator_exclusive_slots.py
lib/portage/tests/resolver/test_slot_operator_missed_update.py
lib/portage/tests/resolver/test_slot_operator_rebuild.py
lib/portage/tests/resolver/test_slot_operator_required_use.py
lib/portage/tests/resolver/test_slot_operator_reverse_deps.py
lib/portage/tests/resolver/test_slot_operator_runtime_pkg_mask.py
lib/portage/tests/resolver/test_slot_operator_unsatisfied.py
lib/portage/tests/resolver/test_slot_operator_unsolved.py
lib/portage/tests/resolver/test_slot_operator_update_probe_parent_downgrade.py
lib/portage/tests/resolver/test_solve_non_slot_operator_slot_conflicts.py
lib/portage/tests/resolver/test_targetroot.py
lib/portage/tests/resolver/test_unecessary_slot_upgrade.py
lib/portage/tests/resolver/test_unmerge_order.py
lib/portage/tests/resolver/test_use_dep_defaults.py
lib/portage/tests/resolver/test_useflags.py
lib/portage/tests/resolver/test_virtual_minimize_children.py
lib/portage/tests/resolver/test_virtual_slot.py
lib/portage/tests/resolver/test_with_test_deps.py
lib/portage/tests/resolver/binpkg_multi_instance/__init__.py
lib/portage/tests/resolver/binpkg_multi_instance/__test__.py
lib/portage/tests/resolver/binpkg_multi_instance/test_build_id_profile_format.py
lib/portage/tests/resolver/binpkg_multi_instance/test_rebuilt_binaries.py
lib/portage/tests/resolver/soname/__init__.py
lib/portage/tests/resolver/soname/__test__.py
lib/portage/tests/resolver/soname/test_autounmask.py
lib/portage/tests/resolver/soname/test_depclean.py
lib/portage/tests/resolver/soname/test_downgrade.py
lib/portage/tests/resolver/soname/test_or_choices.py
lib/portage/tests/resolver/soname/test_reinstall.py
lib/portage/tests/resolver/soname/test_skip_update.py
lib/portage/tests/resolver/soname/test_slot_conflict_reinstall.py
lib/portage/tests/resolver/soname/test_slot_conflict_update.py
lib/portage/tests/resolver/soname/test_soname_provided.py
lib/portage/tests/resolver/soname/test_unsatisfiable.py
lib/portage/tests/resolver/soname/test_unsatisfied.py
...
lib/portage/tests/sets/base/testInternalPackageSet.py
lib/portage/tests/sets/files/__init__.py
lib/portage/tests/sets/files/__test__.py
lib/portage/tests/sets/files/testConfigFileSet.py
lib/portage/tests/sets/files/testStaticFileSet.py
lib/portage/tests/sets/shell/__init__.py
lib/portage/tests/sets/shell/__test__.py
lib/portage/tests/sets/shell/testShell.py
...
lib/portage/tests/unicode/test_string_format.py
lib/portage/tests/update/__init__.py
lib/portage/tests/update/__test__.py
lib/portage/tests/update/test_move_ent.py
lib/portage/tests/update/test_move_slot_ent.py
lib/portage/tests/update/test_update_dbentry.py
lib/portage/tests/util/__init__.py
lib/portage/tests/util/__test__.py
lib/portage/tests/util/test_checksum.py
lib/portage/tests/util/test_digraph.py
lib/portage/tests/util/test_file_copier.py
lib/portage/tests/util/test_getconfig.py
lib/portage/tests/util/test_grabdict.py
lib/portage/tests/util/test_install_mask.py
lib/portage/tests/util/test_normalizedPath.py
lib/portage/tests/util/test_shelve.py
lib/portage/tests/util/test_socks5.py
...
lib/portage/tests/util/test_varExpand.py
lib/portage/tests/util/test_whirlpool.py
lib/portage/tests/util/test_xattr.py
lib/portage/tests/util/dyn_libs/__init__.py
lib/portage/tests/util/dyn_libs/__test__.py
lib/portage/tests/util/dyn_libs/test_soname_deps.py
...
lib/portage/tests/util/file_copy/test_copyfile.py
...
lib/portage/tests/util/futures/test_done_callback_after_exit.py
lib/portage/tests/util/futures/test_iter_completed.py
...
lib/portage/tests/util/futures/asyncio/test_child_watcher.py
...
lib/portage/tests/util/futures/asyncio/test_policy_wrapper_recursion.py
...
lib/portage/tests/util/futures/asyncio/test_wakeup_fd_sigchld.py
