...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'x86_64-pc-linux-gnu-gcc -pthread -shared',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '',
 'CONFIGURE_CFLAGS_NODIST': '-march=x86-64 -O3 -pipe -fwrapv -std=c99 -Wextra '
 ...
 'CONFIGURE_LDFLAGS': '',
 'CONFIGURE_LDFLAGS_NODIST': '-Wl,-O1 -Wl,--as-needed',
 'CONFIG_ARGS': "'--prefix=/usr' '--build=x86_64-pc-linux-gnu' "
                "'--host=x86_64-pc-linux-gnu' '--mandir=/usr/share/man' "
                "'--infodir=/usr/share/info' '--datadir=/usr/share' "
                "'--sysconfdir=/etc' '--localstatedir=/var/lib' "
                "'--docdir=/usr/share/doc/python-3.10.2_p1' "
                "'--htmldir=/usr/share/doc/python-3.10.2_p1/html' "
                "'--libdir=/usr/lib64' 'ac_cv_header_stropts_h=no' "
                "'--enable-shared' '--without-static-libpython' "
                "'--enable-ipv6' '--infodir=/usr/share/info' "
                ...
                "'--disable-optimizations' '--with-readline=readline' "
                "'build_alias=x86_64-pc-linux-gnu' "
                "'host_alias=x86_64-pc-linux-gnu' 'CFLAGS=' 'LDFLAGS=' "
                "'CPPFLAGS= -I/usr/include/ncursesw'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/var/tmp/portage/dev-lang/python-3.10.2_p1/work/Python-3.10.2/coverage.info',
 'COVERAGE_REPORT': '/var/tmp/portage/dev-lang/python-3.10.2_p1/work/Python-3.10.2/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -I/usr/include/ncursesw',
 'CXX': 'x86_64-pc-linux-gnu-g++ -pthread',
 'DESTDIRS': '/usr /usr/lib64 /usr/lib/python3.10/lib-dynload',
 ...
 'PY_CFLAGS_NODIST': '-march=x86-64 -O3 -pipe -fwrapv -std=c99 -Wextra '
                     '-Wno-unused-result -Wno-unused-parameter '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -march=x86-64 '
                   ...
                   '-I/usr/include/ncursesw -fPIC -DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-O1 -Wl,--as-needed',
 'PY_CPPFLAGS': '-I. -I./Include -I/usr/include/ncursesw',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '',
 'PY_LDFLAGS_NODIST': '-Wl,-O1 -Wl,--as-needed',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.10.2_p1/work/Python-3.10.2',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.10.2_p1/work/Python-3.10.2 '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/var/tmp/portage/dev-lang/python-3.10.2_p1/work/Python-3.10.2 '
 ...
 'abs_builddir': '/var/tmp/portage/dev-lang/python-3.10.2_p1/work/Python-3.10.2',
 'abs_srcdir': '/var/tmp/portage/dev-lang/python-3.10.2_p1/work/Python-3.10.2',
