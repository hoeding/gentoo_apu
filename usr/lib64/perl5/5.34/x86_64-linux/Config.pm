...
tie %Config, 'Config', {
    archlibexp => '/usr/lib64/perl5/5.34/x86_64-linux',
    ...
    osname => 'linux',
    osvers => '5.10.78-gentoo-dist',
    path_sep => ':',
    privlibexp => '/usr/lib64/perl5/5.34',
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib64/perl5/5.34/x86_64-linux',
    sitelibexp => '/usr/local/lib64/perl5/5.34',
    so => 'so',
    useithreads => undef,
