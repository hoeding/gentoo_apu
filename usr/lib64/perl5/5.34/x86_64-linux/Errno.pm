...
"x86_64-linux-5.10.78-gentoo-dist" or
	die "Errno architecture (x86_64-linux-5.10.78-gentoo-dist) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
