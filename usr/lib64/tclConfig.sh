...
TCL_CC='x86_64-pc-linux-gnu-gcc'
...
TCL_LD_FLAGS='-Wl,-O1 -Wl,--as-needed -Wl,--export-dynamic '
...
TCL_RANLIB='x86_64-pc-linux-gnu-ranlib'
...
# compiled.
TCL_SRC_DIR='/usr/lib64/tcl8.6/include'
...
TCL_BUILD_STUB_LIB_PATH='/usr/lib64/libtclstub8.6.a'
